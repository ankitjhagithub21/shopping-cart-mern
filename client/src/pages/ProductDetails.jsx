                            ...
                            <div className="lg:w-1/2 w-full p-8">
                                <div className="relative">
                                    ...
                                    <div className="relative bg-gray-50 rounded-2xl overflow-hidden mb-6 group">
                                        ...
                                        {/* Zoom Icon */}
                                        <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
